...
// dotnet run --project scripts/dotnet/XiaoShengAIDocx.Cli -- run-script task.csx
...
```bash
dotnet run --project scripts/dotnet/XiaoShengAIDocx.Cli --
```
...
Note: `Samples/` path is relative to `scripts/dotnet/XiaoShengAIDocx.Core/`.
