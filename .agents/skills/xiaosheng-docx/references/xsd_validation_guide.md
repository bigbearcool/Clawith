...
dotnet run --project xiaosheng-docx validate input.docx --xsd assets/xsd/wml-subset.xsd

# Validate against business rules (REQUIRED for Scenario C gate-check)
dotnet run --project xiaosheng-docx validate input.docx --xsd assets/xsd/business-rules.xsd

# Validate against both
dotnet run --project xiaosheng-docx validate input.docx --xsd assets/xsd/wml-subset.xsd --xsd assets/xsd/business-rules.xsd
```
