#!/usr/bin/env bash
# make.sh — xiaosheng-pdf unified CLI
...
[
  ...
  {"type":"body",    "text":"This document was generated by xiaosheng-pdf — a skill for creating visually polished PDFs. Every design decision is rooted in the document type and content, not a generic template."},
...
JSON
  ...
  cmd_run \
    --title   "xiaosheng-pdf demo" \
    --type    "report" \
    --author  "xiaosheng-pdf skill" \
    --date    "$(date '+%B %Y')" \
